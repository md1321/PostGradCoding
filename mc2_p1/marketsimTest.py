...
class Mc2P1Test(unittest.TestCase):
    def try_assess_portfolio(self, portvals):
        ...
        try:
            cum_ret, avg_daily_ret, std_daily_ret, sharpe_ratio = marketsim_editedv4.assess_my_portfolio(portvals)
        except AttributeError:
            statsMethodExists = False
    ...
    def test_orders_short(self):
        portvals = marketsim_editedv4.compute_portvals(orders_file = "/home/ml4t/PycharmProjects/mc2_p1/orders/orders-short.csv", start_val=1000000)
        ...
        success, cum_ret, avg_daily_ret, std_daily_ret, sharpe_ratio = self.try_assess_portfolio(portvals)
    ...
    def test_orders(self):
        portvals = marketsim_editedv4.compute_portvals(orders_file = "/home/ml4t/PycharmProjects/mc2_p1/orders/orders.csv", start_val=1000000)
        final_portfolio_value = portvals.ix[-1,:][0]
        final_portfolio_dataframe_length = len(portvals)
    ...
    #     portvals = marketsim_editedv4.compute_portvals(orders_file = "./orders/orders-02.csv", start_val=1000000)
    #     final_portfolio_value = portvals.ix[-1,:][0]
    #     final_portfolio_dataframe_length = len(portvals)
    #
    ...
    # #     portvals = marketsim_editedv4.compute_portvals(orders_file = "./orders/orders-leverage-4.csv", start_val=1000000)
    # #     final_portfolio_value = portvals.ix[-1,:][0]
    # #     final_portfolio_dataframe_length = len(portvals)
    # #
    # #     expected_value = 998035.0
